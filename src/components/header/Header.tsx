    ...
    <div className="w-full h-20 bg-amazon_blue text-lightText sticky top-0 z-50">
      <div className="h-full w-full mx-auto inline-flex items-center justify-between gap-1 mdl:gap-3 px-4">
        ...
        {userInfo ? (
          ...
          <div
            onClick={() => signIn()}
            className="text-xs text-gray-100 flex flex-col justify-center px-2 border border-transparent hover:border-white curser-pointer duration-300 h-[70%]"
          >
            <p>Hello, sing in</p>
        ...
        <div className="text-xs text-gray-100 flex flex-col justify-center px-2 border border-transparent hover:border-white curser-pointer duration-300 h-[70%] relative">
          <p>Marked</p>
